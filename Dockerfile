# ===================================================================
# Dockerfile para o site Notreve Tech (HTML + PHP)
# ===================================================================

# PASSO 1: Usar uma imagem oficial do PHP com o servidor Apache.
# A versão 'alpine' é mais leve, o que resulta em uma imagem menor.
...
# Isso evita problemas de permissão se o PHP precisar escrever logs, por exemplo.
